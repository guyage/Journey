<template>
    <div id="todosqlorder" class="todosqlorder">
        <el-row style="padding-bottom:5px;">
            <div class="todosqlorder-operation">
...
import { getToDoSqlOrder } from '@/api/sqlorder.js';
export default {
    // name: 'todosqlorder',
    data () {
        return {
...
<style>
.todosqlorder .el-collapse-item__header.is-active,.todosqlorder .el-collapse-item__header{
    font-size: 16px;
    font-weight: bold;
    padding-left: 0.5em;
