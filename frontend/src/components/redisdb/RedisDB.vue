...
export default {
    ...
    data () {
        return {
            ...
            dataformlabel: {
                // id: { label: 'Mongodb实例名称', selected: false},
                name: { label: '数据库名称', selected: false },
                host: { label: 'IP', selected: false },
                port: { label: '端口', selected: false },
                password: { label: '密码', selected: false },
