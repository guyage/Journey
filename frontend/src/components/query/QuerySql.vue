<template>
    <div class="querysql" id="querysql">
        <el-collapse v-model="activeNames">
            <el-collapse-item title="QuerySql" name="1">
                ...
                <div id="querysql-sql" class="querysql-sql">
                    <div class="querysql-sql-input-help">
                    ...
                    <div id="querysql-sql-button" class="querysql-sql-button">
                        ...
                        <el-button title="Explain" class="query-sql-button-exec" @click="handleSql('explain')" size="mini" circle>
                            <icon-svg class="querysql-sql-button-exec-icon" iconClass="icon-explain"></icon-svg>
                        </el-button>
                        <el-button title="导出Excel" class="query-sql-button-exec" @click="exportExcel" size="mini" circle>
                            <icon-svg class="querysql-sql-button-exec-icon" iconClass="icon-excel"></icon-svg>
                        </el-button>
                    </div>
...
<style>
.querysql .el-collapse-item__header.is-active,.querysql .el-collapse-item__header{
    font-size: 16px;
    font-weight: bold;
    padding-left: 0.5em;
