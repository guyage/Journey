            ...
            <el-tabs v-model="sqltabsvalue" type="border-card" editable @edit="handleTabsEdit" @tab-click="handleClick">
                ...
                :name="item.name">
                    ...
                    <div  class="query-sql-results-table">
                        <el-table :element-loading-text="loadingtext" v-loading="loading" style="width: 100%" highlight-current-row height="500" border :data="item.results.slice((currentPage-1)*pagesize,currentPage*pagesize)">
