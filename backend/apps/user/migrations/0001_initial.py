# Generated by Django 2.0.4 on 2019-04-17 09:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webcat', models.CharField(blank=True, max_length=120, verbose_name='微信')),
                ('comment', models.CharField(blank=True, max_length=64, verbose_name='备注')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('jwt_secret', models.UUIDField(default=uuid.UUID('b05b642f-ef7c-4e68-a437-eb321e86ba41'), verbose_name='用户jwt加密秘钥')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='user.PermissionsGroup'),
        ),
        migrations.AddField(
            model_name='users',
