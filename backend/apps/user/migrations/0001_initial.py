# Generated by Django 2.0.4 on 2019-08-12 06:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jwt_secret', models.UUIDField(default=uuid.UUID('ca80e5be-3841-492f-96a9-02183f39300c'), verbose_name='用户jwt加密秘钥')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mtype', models.IntegerField(blank=True, verbose_name='菜单类型 0:目录 1:菜单 2:按钮')),
        ...
        migrations.AddField(
            model_name='users',
            name='roles',
            field=models.ManyToManyField(blank=True, to='user.Role', verbose_name='拥有的所有角色'),
        ),
        migrations.AddField(
            model_name='users',
