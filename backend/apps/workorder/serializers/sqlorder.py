...
from workorder.models.approvalgroup import ApprovalGroup
import json
...
class SqlOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SqlOrder
        fields = ('id','title','ordertype','classify','ordertypename','have_step','approver_group','status','creator','operator','create_time','update_time')
