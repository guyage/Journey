    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manage_userpwd', models.CharField(blank=True, max_length=255, verbose_name='MongoDBInst管理用户密码')),
                ('read_user', models.CharField(blank=True, max_length=32, verbose_name='MongoDBInst只读用户')),
                ('read_userpwd', models.CharField(blank=True, max_length=255, verbose_name='MongoDBInst只读用户密码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manage_userpwd', models.CharField(blank=True, max_length=255, verbose_name='MySQLInst管理用户密码')),
                ('read_user', models.CharField(blank=True, max_length=32, verbose_name='MySQLInst只读用户')),
                ('read_userpwd', models.CharField(blank=True, max_length=255, verbose_name='MySQLInst只读用户密码')),
                ('role', models.CharField(blank=True, choices=[('Master', 'Master'), ('Slave', 'Slave')], default='Master', max_length=12, verbose_name='是否启用')),
                ('services', models.CharField(blank=True, max_length=255, verbose_name='涉及服务')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=255, verbose_name='Redis密码')),
                ('role', models.CharField(blank=True, choices=[('Master', 'Master'), ('Slave', 'Slave')], default='Master', max_length=12, verbose_name='是否启用')),
                ('services', models.CharField(blank=True, max_length=255, verbose_name='涉及服务')),
