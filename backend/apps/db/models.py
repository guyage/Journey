...
class MySQLInst(models.Model):
    ...
    manage_userpwd = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"MySQLInst管理用户密码")
    read_user = models.CharField(max_length=32, blank=True, null=False, verbose_name=u"MySQLInst只读用户")
    read_userpwd = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"MySQLInst只读用户密码")
...
class MongoDBInst(models.Model):
    ...
    manage_userpwd = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"MongoDBInst管理用户密码")
    read_user = models.CharField(max_length=32, blank=True, null=False, verbose_name=u"MongoDBInst只读用户")
    read_userpwd = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"MongoDBInst只读用户密码")
    role = models.CharField(choices=ROLE_CHOICE,blank=True,max_length=12, default='Master',verbose_name=u"是否启用")
    services = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"涉及服务")
...
class RedisInst(models.Model):
    ...
    password = models.CharField(max_length=255, blank=False, null=False, verbose_name=u"Redis密码")
    role = models.CharField(choices=ROLE_CHOICE,blank=True,max_length=12, default='Master',verbose_name=u"是否启用")
    services = models.CharField(max_length=255, blank=True, null=False, verbose_name=u"涉及服务")
